...
?>
	...
	<div class="wrap snillrik-settings">
		...
		<form method="post" action="options.php">
			...
			$redirectprofile = get_option('snillrik_settings_redirectprofile', array());
				...
				<div class="snillrik-settings-row">
					<div class="snillrik-settings-item">
						<div class="snillrik-settings-item-inner">
							...
							<label class="<?php echo esc_attr($switchname); ?>">
				...
				<div class="snillrik-settings-row">
					...
					<div class="snillrik-settings-item">
						<div class="snillrik-settings-item-inner">
							...
							<p>Redirects to some other page than the profile page.</p>
							<label class="<?php echo esc_attr($switchname); ?>">
								<input type="checkbox" <?php echo $redirectprofile ? "checked" : ""; ?> id="snillrik_settings_redirectprofile" name="snillrik_settings_redirectprofile">
								<div class="snillrik-settings-slider"></div>
							</label>

							<select name="snillrik_settings_redirectprofile_page">
								<?php
								echo '<option value="home" ' . selected('home', esc_attr($snillrik_settings_redirectprofile_page)) . '>Home</option>';
								echo '<option value="admin" ' . selected('admin', esc_attr($snillrik_settings_redirectprofile_page)) . '>Admin</option>';
								if ($pages = get_pages()) {
									foreach ($pages as $page) {
										echo '<option value="' . intval($page->ID) . '" ' . selected(intval($page->ID), esc_attr($snillrik_settings_redirectprofile_page)) . '>' . esc_attr($page->post_title) . '</option>';
									}
								}
								?>
							</select>
